...
const getLineData = (name: string, index: number) => {
...
const getContentSource = (name: string) => {
...
setupMock({
  setup: () => {
    ...
    Mock.mock(new RegExp('/api/multi-dimension/card'), (params: any) => {
